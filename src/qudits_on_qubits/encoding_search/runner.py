...
from qudits_on_qubits.encoding_search.candidates import (
    Candidate,
...
from qudits_on_qubits.encoding_search.paths import stage_file_prefix, stage_output_dir
from qudits_on_qubits.encoding_search.preselection import load_preselected_candidates, select_preselected_rows
...
def benchmark_basis(*args, **kwargs):
    from qudits_on_qubits.core.benchmark_encoding_bases import benchmark_basis as _benchmark_basis
