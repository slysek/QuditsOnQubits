...
- [IQM automatic layout selection](#iqm-automatic-layout-selection)
- [Schema-v3 artifacts and resume behavior](#direct-pipeline-and-final-artifact)
- [Bootstrap uncertainty](#bootstrap-uncertainty)
- [Repository layout](#layout)
- [Frozen reference experiments](#frozen-reference-experiments)
- [Direct-basis Top-K selection](#direct-basis-top-k-selection)
- [Rerun candidate selection](#direct-basis-rerun-candidate-selection)
- [IQM direct-basis transpilation](#iqm-direct-basis-transpilation)
- [IQM transpiler harness](#iqm-transpiler-harness)
- [Optimized F3 and CZ3](#optimized-f3-and-cz3-in-the-benchmark)
- [PiastQ managed Bell execution](#piastq-managed-bell-execution)
- [Reproducible Bell hardware benchmark](#reproducible-bell-hardware-benchmark)
- [Randomized Bell blocks](#independent-local-bell-settings-in-raw-blocks)
...
See the [clean-install verification](two_qutrit_bell_vertical_slice.md#clean-installation)
and [troubleshooting](two_qutrit_bell_vertical_slice.md#troubleshooting) for
distribution builds, PowerShell activation, and Aer issues. The
[PiastQ section](#piastq-managed-bell-execution) describes its separately installed
client, managed compilation contract, and isolated offline integration checks.
