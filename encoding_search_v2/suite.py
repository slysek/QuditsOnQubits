...
from encoding_search_v2.paths import default_results_root
...
from encoding_search_v2.states import (
    BenchmarkStateSpec,
...
def generate_all_class_candidates(
    ...
    suite.
    """
    from QuditsOnQubits.benchmark_encoding_bases_parallel import (
