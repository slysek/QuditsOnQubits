...
(narrative cells in Polish) contains the initial RAW / readout mitigation /
twirling + DD / ZNE experiment.
...
The five-scale folder also contains `statistical_diagnostics.md` (Polish) and `.json`:
